...
- [x] **Task 10 — FAQ секция** — `src/app/[locale]/page.tsx` в конце. Аккордеон на `useState`, 6 вопросов через i18n ключи `faq.q1/a1...faq.q6/a6`. Стиль `bg-slate-800 border-slate-700`. Коммит: `"feat: add FAQ section"`
